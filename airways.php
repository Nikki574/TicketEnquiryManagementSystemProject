...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['name'], $_POST['mobile'], $_POST['email'], $_POST['source'], $_POST['destination']) &&
        ...
        $sql = "SELECT airline_name, price, departure_time, arrival_time FROM flight_routes WHERE source = :source AND destination = :destination";
        ...
        try {
            ...
            if ($results) {
                ...
                echo "<h2 class='ticket-title'>AIRWAYS Ticket</h2>";
                ...
                foreach ($results as $result) {
                    $airline_name = htmlspecialchars($result['airline_name']);
                    ...
                    echo "<p><strong>flight Name:</strong> $airline_name</p>";
...
<head>
    ...
    <style>
        body {
            ...
            align-items: center;
            min-height: 100vh;
            background: url('airways.jpg') no-repeat center center/cover;
            color: #fff;
        }
